...
from .fastapi_routers import patients, visits, lab_results, imaging, spirometry, diagnostic, ws_diagnostic, rag, auth, model_validation
...
app.include_router(ws_diagnostic.router)
